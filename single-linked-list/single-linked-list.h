...
public:
    ...
    Iterator InsertAfter(ConstIterator pos, const Type& value) {
        ...
        auto old_next_node = it.node_->next_node;
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        ...
        auto delete_node = it.node_->next_node;
        auto new_next_node = delete_node->next_node;
        delete delete_node;
        it.node_->next_node = new_next_node;
        --size_;
...
private:
    ...
    void Assign(const ItType& first, const ItType& last) {

        SingleLinkedList tmp;
        Node* last_node = nullptr;
        for (auto it_node = first; it_node != last; ++it_node) {
            if(it_node == first) {
                tmp.head_.next_node = new Node(*it_node, nullptr);
                last_node = tmp.head_.next_node;
            } else {
                last_node->next_node = new Node(*it_node, nullptr);
